            ...
            <div id="default-carousel" className="relative" data-carousel="static">
                ...
                <div className="overflow-hidden relative h-56 rounded-lg sm:h-64 xl:h-80 2xl:h-96">
                    ...
                    <div className="duration-700 ease-in-out" data-carousel-item>
                        ...
                        <img src= {carousel1.src} className="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2"  />
                    </div>
                    
                    <div className="duration-700 ease-in-out" data-carousel-item>
                        <img src= {carousel2.src} className="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2"  />
                    </div>
                    
                    <div className="duration-700 ease-in-out" data-carousel-item>
                        <img src= {carousel3.src} className="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2"  />
                    </div>
                </div>
